...
while ports["in"] and ports["out"]:
    try:
        ...
        climate_id = int(common.get_fbp_attr(in_ip, "climate_id").as_text())
        ...
        env_template["pathToClimateCSV"] = str(PATH_TO_REPO / f"data/Results_{year}/result_{climate_id:05d}_{year}.csv")
