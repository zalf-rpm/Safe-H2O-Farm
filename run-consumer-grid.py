...
PATHS = {
    "re-local-remote": {
        ...
        "path-to-output-dir": "D:/Safe-H2O-Farm/out/out/",
        "path-to-csv-output-dir": "D:/Safe-H2O-Farm/out/csv-out/"
    },
    "mbm-local-remote": {
        "path-to-data-dir": "data/",
...
TEMPLATE_SOIL_PATH = "{local_path_to_data_dir}italy/it_soil_1000_32633_etrs89-utm33n.asc"
USE_LANDUSE = False
...
def write_row_to_grids(row_col_data, row, ncols, header, path_to_output_dir, path_to_csv_output_dir, setup_id):
    ...
    output_grids = {
        ...
        # "SOC-sum": {"data": make_dict_nparr(), "cast-to": "float", "digits": 2},
        "DOY-3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 2},
